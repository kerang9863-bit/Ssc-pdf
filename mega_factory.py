...
def fetch_content(subject: str, prompt_detail: str, key_idx: int, retries: int = 3) -> Tuple[Optional[str], bool]:
    ...
    full_prompt = (
        ...
        "STRICT FORMAT:\n"
        "1. Each question MUST start with Q1. , Q2. , Q3. etc.\n"
        "2. After each question, write Ans: followed by the answer\n"
        "3. For Math: Include Short Trick: and Solution: for every question\n"
        "4. Plain text only, no markdown, no ** markers\n"
        "5. Number sequentially from Q1 to Q20"
    )
